...
class VideoPlay extends PureComponent < Props > {
  constructor(props) {
    super(props);
    this.handleSwitchChannel = this
      .handleSwitchChannel
      .bind(this);
    this.onComeback = this
      .onComeback
      .bind(this);
    this.onSourceSelected = this
      .onSourceSelected
      .bind(this);
    this.onSwitchSource = this
      .onSwitchSource
      .bind(this);
  }
  state = {
  ...
  onSwitchSource() {
    ...
    const currentVideoUrl = this
      .webview
      .getURL();
    this.setState({url: `${selectedUrl.url}${currentVideoUrl}`});
  }
  render() {
